<template>
    <div class="bg-white">
        ...
        <JovencioDatatable :locale="locale" v-if="showDataTable" :columns="tableColumns" :update="updateAjax" :options="optionsDataTable" @trigger="listenTrigger" @listen="listenTrigger2" />
    </div>
</template>
