...
export default {
    ...
    methods: {
        ...
        addCriteria() {
            ...
            let criteria = {"criteria":[{"condition":"contains","data":"Deal","origData":"item","type":"example-mix","value":["oi"],"value1":"oi","origCond":"teste"}],"logic":"AND"};
            // @ts-ignore
            this.criteriaBuilder = criteria ? criteria : null;
        }
    }
};
</script>